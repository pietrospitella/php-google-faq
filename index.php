...
<body>
        ...
        <div id="main_cont">
            <?php 
                $faqs = [
                    ...
                    [
                        "quest" => "<h2>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h2>",
                        "answ" => "<p>Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.</p>
                    ...
                    [
                        "quest" => "<h2>Perché il mio account è associato a un paese?</h2>",
                        "answ" => "<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
                        <ol>
                        ...
                        <h3 class='h3'>Stabilire il paese associato al tuo account</h3>
                        <p class='p'>Quando crei un nuovo Account Google, lo associamo a un paese in base a dove è stato creato. Per quanto riguarda gli account creati almeno un anno fa, usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui hai trascorso più tempo nell'ultimo anno.</p>
    ...
    <footer>
        <div id="left_footer">
            <ul>
                <li><a href="#">Google</a><span> &centerdot;</span></li>
                <li><a href="#">Tutto su Google</a><span> &centerdot;</span></li>
                <li><a href="#">Privacy</a><span> &centerdot;</span></li>
